...
export default function UserGuide() {
  return (
    <Flex >
      ...
      <FileIcon name="Руководство пользователя портала цифровых услуг АО «Мособлэнерго»" sizeKb={3100} url={"https://mosoblenergo.ru/uploads/Rukovodstvo_polzovatelya_portala_czifrovyh_uslug_AO_Mosoblenergo_5f0ed05b97.pdf"} ext={".pdf"} />
    </Flex>
  );
}